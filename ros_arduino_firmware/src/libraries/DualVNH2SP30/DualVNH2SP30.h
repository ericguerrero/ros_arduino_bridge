#ifndef DualVNH2SP30_h
#define DualVNH2SP30_h
...
class DualVNH2SP30
{
  public:  
    // CONSTRUCTORS
    DualVNH2SP30(); // Default pin selection.
    DualVNH2SP30(unsigned char INA1, unsigned char INB1, unsigned char EN1DIAG1, unsigned char CS1, 
